...
``argument`` decorators, whose ``type: ParamType[Unknown]`` parameter makes
...
keeps the rest of this tooling strict-clean without disabling the rule. This
...
Other click members (``command``, ``group``, ``echo``, ``Choice``, ``Path`` …)
